...
tokenizer = AutoTokenizer.from_pretrained("google/flan-t5-xl", use_auth_token=HUGGINGFACEHUB_API_TOKEN)
model = AutoModelForSeq2SeqLM.from_pretrained("google/flan-t5-xl", use_auth_token=HUGGINGFACEHUB_API_TOKEN)
